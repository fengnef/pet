...
<head>
    ...
    <script src="/static/js/petkindandcategory.js"></script>
</head>
<body>
    <table id="petkindandcategory_datagrid"></table>
    <%--表格的顶部工具栏--%>
    <div id="petkindandcategory_toolbar">
        <a href="#" class="easyui-linkbutton"
           data-options="iconCls:'icon-add',plain:true" onclick="add()">新增</a>
        宠物种类: <input type="text" name="keyword"/>
        <a href="#" class="easyui-linkbutton"
    ...
    <%--编辑增加页面--%>
    <div id="petkindandcategory_dialog">
        <form id="editForm" method="post">
            <input type="hidden" name="id"/>
            <table align="center" style="margin-top: 30px">
                <tr>
                    <td>宠物类别:</td>
                    <td><input type="text" name="petcategory"></td>
                </tr>
                <tr>
                    <td>宠物种类:</td>
    ...
    <%--弹出框的底部工具栏--%>
    <div id="petkindandcategory_buttons">
        <a href="#" class="easyui-linkbutton"
