...
<head>
    ...
    <script src="/static/js/manufacturer.js"></script>
</head>
<body>
    <table id="manu_datagrid"></table>
    <%--表格的顶部工具栏--%>
    <div id="manu_toolbar">
        <a href="#" class="easyui-linkbutton"
           data-options="iconCls:'icon-add',plain:true" onclick="add()">新增</a>
        生产产地名称:     <input type="text" name="keyword"/>
        <a href="#" class="easyui-linkbutton"
    ...
    <div id="manu_dialog">
        <form id="editForm" method="post">
            ...
            <table align="center" style="margin-top: 30px">
                <tr>
                    <td>品牌产地名称:</td>
                    <td><input type="text" name="productoriginname"></td>
                </tr>
                <tr>
                    <td>是否启用:</td>
                    <td>
