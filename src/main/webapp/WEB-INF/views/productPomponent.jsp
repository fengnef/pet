...
<head>
    ...
    <script src="/static/js/productPomponent.js"></script>
</head>
<body>
    <table id="productPomponent_datagrid"></table>
    <%--表格的顶部工具栏--%>
    <div id="productPomponent_toolbar">
        <a href="#" class="easyui-linkbutton"
           data-options="iconCls:'icon-add',plain:true" onclick="add()">新增</a>
        成分名称:  <input type="text" name="keyword"/>
        <a href="#" class="easyui-linkbutton"
    ...
    <%--编辑增加页面--%>
    <div id="productPomponent_dialog">
        <form id="editForm" method="post">
            <input type="hidden" name="id"/>
            <table align="center" style="margin-top: 30px">
                <tr>
                    <td>商品成分名称:</td>
                    <td><input type="text" name="pomponentname"></td>
                </tr>
                <tr>
                    <td>是否启用:</td>
                    <td>
    ...
    <%--弹出框的底部工具栏--%>
    <div id="productPomponent_buttons">
        <a href="#" class="easyui-linkbutton"
